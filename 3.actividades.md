...
21.  Busca la tarea de Gradle para realizar los tests y ejecútalos. Puedes acceder a ellos en `View` -> `Tools Windows` -> `Gradle`. También puedes acceder pulsando en el icono del elefante que tienes en la parte derecha superior.
<hr>

22.  A continuación vamos a trabajar la **cobertura de código** de los tests.
